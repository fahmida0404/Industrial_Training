...
my_list = [[3, 5, 4], [9, 3, 1], [0, 7, 2]]
print("My list: ",my_list)
element = my_list[1][0]
print("Accessing an element: ", element)

my_list[0].append(6)
print("After appending in the first row: ",my_list)

my_list[1].insert(2, 8)
print("After inserting in the second row: ",my_list)

my_list[2].pop()
print("After popping from the third row: ",my_list)

print("Iterating through the second row: ",my_list[1])
print("Iterating a range from the first row: ",my_list[0][1:3])
...
my_tuple = ("Fahmida", 3, "Akter", 8.6)
print("My tuple: ",my_tuple)

element = my_tuple[0]
print("First element of my tuple: ",element)
...
list_of_tuples = [("Fahmida", 3.75), ("Chaity", 3.5), ("Rownok", 3.64), ("Nishat", 3.8)]
print("Before sorintg: ",list_of_tuples)

list_of_tuples = sorted(list_of_tuples, key = lambda x : x[1], reverse = True) #lambda function to specify which column to use while sorting
print("After sorintg: ",list_of_tuples)
