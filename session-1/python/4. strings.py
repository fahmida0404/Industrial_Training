...
bio_data = "Name: Fahmida, Age: 24, Country: Bangladesh"
print("Bio data as a string: ", bio_data)
...
my_dict = {"Name": "Fahmida", "Age": 24, "Country": "Bangladesh"}
name = my_dict["Name"]
age = my_dict["Age"]
country = my_dict["Country"]

print(f"Assalamu Alaikum. My name is {name} and I am {age} years old. I am from {country}.")
...
def count_str(s):
    str_dict = dict()
    for i in s:
        str_dict[i] = s.count(i)
    print("Counts of each character: ",str_dict)

count_str("My name is Fahmida Akter.")
...
print("All the hashtags: ",hashtags)
...
bd_phone = r'(?:\+88)?01+\d{3}+-?\d{6}'
phone_num = "You can call at 01454565767, +8801963456347, 0088785674657 and 01845-567567 numbers."
num_match = re.findall(bd_phone, phone_num)

print("All the valid Bangaldeshi phone numbers: ",num_match)
