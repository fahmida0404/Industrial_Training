...
# printing.py content:
# def input_num(a,b):
#     print(f"The number are {a} and {b}")

# summation.py content:
# def  sum_two_num(a,b):
#     sum= a+b
...
#plotly is a library containing modules and packages to show interactive lines, graphs and charts etc.

import plotly.graph_objects as plotly
from plotly.graph_objects import Bar

x = ['Laptop', 'Smartphone', 'TV']
y = [40000, 55000, 60000]

fig = plotly.Figure(data=Bar(x=x, y=y))

fig.update_layout(
    title="Bar Chart for Price of Electronic Items",
    xaxis_title="Item",
    yaxis_title="Price"
)
